...
public class ProductListResponse extends CommonResponse {
    ...
    public ProductListResponse(int code,String msg,Long product_id,String pd_name,int pd_price,Long brand_id,String pd_category,Long created_who,LocalDateTime created_at,int count_love){
        super(code, msg);
